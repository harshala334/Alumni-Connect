...
const Feedback = () => {
  ...
  return (
    <div className="container-sm mx-40 p-6">
      ...
      {/* Experience Rating */}
      <div className="mb-4">
        <label className="block text-sm font-medium text-gray-600">How would you rate your overall experience with FutureConnect?</label>
        <input
          type="range"
          min="1"
          max="5"
      ...
      {/* Meaningful Dropdown */}
      <div className="mb-4">
        <label className="block text-sm font-medium text-gray-600">Please select the option that best describes your primary reason for using FutureConnect:</label>
        <select
